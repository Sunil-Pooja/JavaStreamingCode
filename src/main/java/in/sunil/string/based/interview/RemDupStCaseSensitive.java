...
public class RemDupStCaseSensitive{
	...
	public static void main(String[] args) {
		...
		String s="Sunil kumar sunil kumar ".toLowerCase();
		
		String string2 = s.chars().distinct().collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append).toString();
		System.out.println(string2+" --string2g");
